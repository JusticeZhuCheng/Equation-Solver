...
namespace EquationSolver
{
    ...
    */
    ...
    class Program
    {
        ...
        static bool IsRightString(string str)
        {
        ...
        static string GetStandardString(string str)
        {
        ...
        static string DeleteBracket(string str)
        {
        ...
        static int GetBracketNum(int num, int index, char[] chars)
        {
            if ('(' == chars[index])
            {
                num++;
        ...
        static Result GetResultFromString(string str)
        {
        ...
        static Result Translate(string str)
        {
        ...
        static string Calculate(string str1, string str2)
        {
            string answer = "";
        ...
        static string ReorganizeEqu(string equ)
        {
            string newEqu = "";
        ...
        static bool CheckInput(string equ)
        {
            int variableNum = 0;
            int equalNum = 0;
        ...
        static string RunSolver(string equ)
        {
            string answer = "";
            //check the input
            if (CheckInput(equ))
